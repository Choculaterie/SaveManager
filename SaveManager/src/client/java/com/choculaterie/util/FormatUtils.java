...
public final class FormatUtils {
    ...
    public static @NonNull String safe(@NonNull String s) {
        return s == null ? "" : s;
    }

    public static @NonNull String formatBytes(long n) {
        if (n < 1024)
            return n + " B";
        int u = -1;
        double d = n;
    ...
    public static @NonNull String shortDate(String iso) {
        if (iso == null)
            return "";
        int t = iso.indexOf('T');
    ...
    public static @NonNull String shortDateMillis(long epochMillis) {
        if (epochMillis <= 0)
            return "";
        return DATE_FMT.format(Instant.ofEpochMilli(epochMillis));
    }

    public static @NonNull String sanitizeFolderName(String s) {
        if (s == null)
            return "";
    ...
    public static @NonNull String extractErrorMessage(Throwable err) {
        if (err == null)
    ...
    public static @NonNull List<String> wrapText(Font textRenderer, @NonNull String text, int maxWidth) {
